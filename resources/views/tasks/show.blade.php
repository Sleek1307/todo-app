...
@section('content')
    <div class="grow m-2 h-full aspect-auto">
        ...
        <div class="flex flex-col grow overflow-hidden p-3 items-center text-white">
            ...
            <h1>Estado: <span>@switch($task->status)
                @case(1)
                    Haciendo
                    @break
                @case(2)
            ...
            <div>
                <a href="" class="mx-5 border-2 border-gray-600 rounded-lg p-1 bg-gray-400">Editar</a>
                <a href="" class="mx-5 border-2 border-gray-600 rounded-lg p-1 bg-gray-400"">Eliminar</a>
            </div>
        </div>
    </div>
@endsection
