...
<body>
    <div class="grid h-screen place-items-center bg-violet-950">
                ...
                <div class="divide-y divide-gray-700">
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        <li class="pl-5">
                            ...
                            {{-- * INICIO Categorias --}}
                            <ul class="pt-2 pb-4 space-y-1 text-xs grid grid-cols-4">
                                ...
                                <li class="col-start-2 col-span-3">
                                    <a rel="noopener noreferrer"
                                        class="flex items-center p-2 space-x-3 rounded-md hover:bg-gray-200 text-gray-500 font-semibold ">
                                        <svg width="16" height="16">
                                            <circle cx="8" cy="8" r="8" fill="lightblue" />
                                        </svg>
                                        <span>Trabajo</span>
                                    </a>
                                </li>
                                ...
                                <li class="col-start-2 col-span-3">
                                    <a rel="noopener noreferrer"
                                        ...
                                        <img src="{{ asset('Svg/All/linear/add-circle-modified.svg') }}" alt="Agregar categoria">
